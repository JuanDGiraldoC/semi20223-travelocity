...
public class DetalleVuelos {
    ...
    public static final Target A_CLASE_ECON_PREMIUM = Target.the("Selector clase economica premium").locatedBy("//div[@id='preferred-class-input']/div/div/a[2]");
    //public static final Target A_CLASE_ECON_PREMIUM = Target.the("Selector clase economica premium").locatedBy("//span[text()='Clase económica Premium']/.."); Se intento con este mapeo y no funciono
    //public static final Target A_CLASE_ECON_PREMIUM = Target.the("Selector clase economica premium").locatedBy("//div[@id="preferred-class-input"]/div/div/a/span[text()='Clase económica Premium']/.."); Se intento con este mapeo y no funciono
    public static final Target SELECT_FECHA_REGRESO = Target.the("selector calendario de regreso").locatedBy("//button[@id='d2-btn']");
    public static final Target FECHA_REGRESO = Target.the("calendar fecha de regreso").locatedByFirstMatching("//button[@data-day='28']");
